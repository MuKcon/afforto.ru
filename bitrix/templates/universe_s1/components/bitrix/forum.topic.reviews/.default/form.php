...
<?
	...
	if (isset($_POST["REVIEW_TEXT"]) && isset($_POST["REVIEW_AUTHOR"]) &&  $_POST["REVIEW_TEXT"] !="" && $_POST["REVIEW_AUTHOR"] !="" && !$arResult["IS_AUTHORIZED"]) {
?>
	<div class="reviews-note-box reviews-note-error">
		<div class="reviews-note-box-text">Спасибо, ваше сообщение отправлено, оно может быть опубликовано после модерации!</div>
	</div>
<?
	}
...
?>
<div class="reviews-reply-form" <?=(($arParams['SHOW_MINIMIZED'] == "Y") ? 'style="display:block;"' : '' )?>>
