                        ...
                        <form action="<?= $arResult['FORM_ACTION'] ?>" method="POST">
                            ...
                            <?php if ($bSubscribed && !$bConfirmed) { ?>
                                <div class="subscribe-edit-confirm">
                                    ...
                                    <input class="subscribe-edit-confirm-button intec-cl-background intec-cl-background-light-hover" type="submit" name="confirm" value="<?= Loc::getMessage('SE_DEFAULT_CONFIRM_BUTTON') ?>" />
                                </div>
                            <?php } ?>
                            <div class="subscribe-edit-buttons">
                                <?php if (!$bSubscribed || $bConfirmed) { ?>
                                    <input type="submit" class="subscribe-edit-button-send intec-cl-background intec-cl-background-light-hover" value="<?= $bSubscribed ? Loc::getMessage('SE_DEFAULT_BUTTONS_EDIT') : Loc::getMessage('SE_DEFAULT_BUTTONS_ADD') ?>" style="margin-right: 20px;" />
                                <?php } ?>
                                <?php if ($arResult['CONSENT']['SHOW']) { ?>
                                    <label class="subscribe-edit-consent intec-input intec-input-checkbox">
