	...
	<div class="poluchit_scidku_wrapp">
		...
		"template.1",
			Array(
				...
				"DESCRIPTION_SHOW" => "Y",
				"DESCRIPTION_TEXT" => 'Просто нажмите на кнопку "Получить скидку", заполните форму и Вы получите первый месяц поддержки по договору абонентского обслуживания компьютерной техники со скидкой 50%',
