...
<div class="service landing ">
	...
	"template.1",
		Array(
			...
			"DESCRIPTION_SHOW" => "Y",
			"DESCRIPTION_TEXT" => 'Просто нажмите на кнопку "Получить скидку", заполните форму и Вы получите первый месяц поддержки по договору IT аутсорсинга со скидкой 50%',
