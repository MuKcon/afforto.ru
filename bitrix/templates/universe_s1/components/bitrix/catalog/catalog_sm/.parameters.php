...
/**********добавляем выбор вариантов отображения секции(список, блоки, таблица)***********/
$arTemplateParameters['SECTION_SELECT_VIEW_ARRS'] = array(
    'PARENT' => 'LIST_SETTINGS',
    'NAME'=> Loc::getMessage('C_CATALOG_SECTION_SELECT_VIEW_ARRS'),
    'TYPE' => 'LIST',
    'REFRESH' => 'N',
    'VALUES' => array(
        'text' => Loc::getMessage('C_CATALOG_LIST_VIEW_TEXT'),
