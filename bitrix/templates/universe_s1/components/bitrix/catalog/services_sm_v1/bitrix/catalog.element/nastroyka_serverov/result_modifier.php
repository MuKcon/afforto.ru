...
$arData['DOCUMENTS']['SHOW'] = !empty($arResult['PROPERTIES'][$arParams["NAME_PROP_DOCUMENTS"]]['VALUE']) ? true : false;

$arDocuments = array();
if (!empty($arResult['PROPERTIES'][$arParams['NAME_PROP_DOCUMENTS']]['VALUE'])) {
    foreach ($arResult['PROPERTIES'][$arParams['NAME_PROP_DOCUMENTS']]['VALUE'] as $fileId) {
...
$arData['DOCUMENTS']['VALUE'] = $arDocuments;
