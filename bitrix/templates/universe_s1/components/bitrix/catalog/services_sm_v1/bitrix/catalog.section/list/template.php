...
?>
<div class="services-section services-section-list">
    <? if ($arParams['PAGE_ELEMENT_COUNT'] > 0 && $navParams['NavPageCount'] > 1) {
        $showTopPager = $arParams['DISPLAY_TOP_PAGER'];
        $showBottomPager = $arParams['DISPLAY_BOTTOM_PAGER'];
        $showLazyLoad = $arParams['LAZY_LOAD'] === 'Y' && $navParams['NavPageNomer'] != $navParams['NavPageCount'];
            ...
            <div class="services-section-items-wrapper" data-entity="<?=$containerName?>">
                ...
                ?>
                    <div class="<?=$rowData['CLASS']?>" data-entity="items-row">
                        <?php if (!$bFiresItem || $bDisplayDescription) { ?>
                            <div class="services-section-delimiter">
                                <div class="services-section-delimiter-wrapper"></div>
                            </div>
                        <?php } ?>
                        <div class="services-section-item">
                            <div class="services-section-item-wrapper" id="<?= $sAreaId ?>">
                                <a href="<?= $arItem['DETAIL_PAGE_URL'] ?>" class="services-section-item-image intec-image-effect" style="background-image: url('<?= $sImage ?>')"></a>
                                <div class="services-section-item-information">
                                    <div class="services-section-item-name">
                                        <a href="<?= $arItem['DETAIL_PAGE_URL'] ?>"
                                           class="services-section-item-name-wrapper intec-cl-text intec-cl-text-dark-hover">
                                            <?= $arItem['NAME'] ?>
                                        </a>
                                    </div>
