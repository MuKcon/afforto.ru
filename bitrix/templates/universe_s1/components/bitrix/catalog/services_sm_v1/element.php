...
$template_detail = "";
$arSelect = Array("ID", "NAME", "PROPERTY_TEMPLATE_DETAIL");
$arFilter = Array("IBLOCK_ID"=>$arParams["IBLOCK_ID"], "ACTIVE_DATE"=>"Y", "ACTIVE"=>"Y", "CODE" => $arResult["VARIABLES"]["ELEMENT_CODE"]);
$res = CIBlockElement::GetList(Array(), $arFilter, false, false, $arSelect);
if($ob = $res->GetNextElement())
{
    $arFields = $ob->GetFields();
    if($arFields["PROPERTY_TEMPLATE_DETAIL_VALUE"]) {
        $template_detail = $arFields["PROPERTY_TEMPLATE_DETAIL_VALUE"];
    }
}
?>
...
<?php $APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "NAME_PROP_DOCUMENTS" => $arParams["NAME_PROP_DOCUMENTS"],
