...
<div class="services-section services-section-tile">
    ...
    <?php if ($bDisplayItems) { ?>
        ...
        <div class="services-section-items services-section-items-<?= $arParams['LINE_COUNT'] ?>">
                ...
                ?>
                    <div class="services-section-item" data-entity="items-row">
                        <div class="services-section-item-wrapper" id="<?= $sAreaId ?>">
                            <a href="<?= $arItem['DETAIL_PAGE_URL'] ?>" class="services-section-item-wrapper-2" style="background-image: url('<?= $sImage ?>')">
                                <div class="services-section-item-background"></div>
                                <div class="services-sections-item-background-gradient"></div>
                                <div class="services-section-item-information">
                                    <div class="services-section-item-name">
                                        <div class="services-section-item-name-wrapper">
