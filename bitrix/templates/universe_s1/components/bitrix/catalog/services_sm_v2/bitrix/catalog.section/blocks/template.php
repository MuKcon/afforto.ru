        ...
        <div class="services-section-items">
            ...
            <div class="services-section-items-wrapper" data-entity="<?=$containerName?>">
                <?php foreach ($arResult['ITEMS'] as $arItem) { ?>
                    <?php $sId = $sTemplateId.'_'.$arItem['ID'];
                    ...
                    if ($arParams['IMAGES'] == 'SQUARE_SMALL')
                        $sImageClass = 'services-section-item-image-square-small';

                    if ($arParams['IMAGES'] == 'SQUARE_BIG') {
                        $sImageClass = 'services-section-item-image-square-big';
                        $arImageSizes = array(
                            'width' => 680,
                            'height' => 578
                        );
                ...
                ?>
                    <div class="services-section-item <?= $sImageClass ?>" data-entity="items-row">
                        <div class="services-section-item-wrapper" id="<?= $sAreaId ?>">
                            <div class="services-section-item-image">
                                <a href="<?= $arItem['DETAIL_PAGE_URL'] ?>" class="services-section-item-image-wrapper intec-image-effect" style="background-image: url('<?= $sImage ?>')"></a>
                            </div>
                            <div class="services-section-item-information">
                                <div class="services-section-item-information-name">
                                    <a href="<?= $arItem['DETAIL_PAGE_URL'] ?>" class="services-section-item-information-name-wrapper intec-cl-text intec-cl-text-dark-hover">
                                        <?= $arItem['NAME'] ?>
                                    </a>
                                </div>
                                <?php if ($arParams['DISPLAY_DESCRIPTION'] == 'Y') { ?>
                                    <div class="services-section-item-information-description">
                                        <?= $arItem['PREVIEW_TEXT'] ?>
                                    </div>
                                <?php } ?>
                            </div>
