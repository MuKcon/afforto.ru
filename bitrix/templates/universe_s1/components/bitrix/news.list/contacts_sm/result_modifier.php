...
$arResult['CONTACT']['SYSTEM_PROPERTIES']['PHONE']['VALUE_CLEAN'] = StringHelper::replace(
    $arResult['CONTACT']['SYSTEM_PROPERTIES']['PHONE']['VALUE'], [
        '-' => '',
        ' ' => '',
        '(' => '',
        ')' => ''
...
$arResult['CONTACT']['SYSTEM_PROPERTIES']['PHONE_HELP']['VALUE_CLEAN'] = StringHelper::replace(
    $arResult['CONTACT']['SYSTEM_PROPERTIES']['PHONE_HELP']['VALUE'], [
        '-' => '',
        ' ' => '',
        '(' => '',
        ')' => ''
