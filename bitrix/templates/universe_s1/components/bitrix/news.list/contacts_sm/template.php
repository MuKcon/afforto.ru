                                    ...
                                    <div class="contacts-contact-parameter-wrapper">
                                        ...
                                        <div class="contacts-contact-text-wrap">
                                            ...
                                            <div class="contacts-contact-text">
                                                ...
                                                <a class="contacts-contact-value" href="<?= 'tel:'.$arContact['SYSTEM_PROPERTIES']['PHONE']['VALUE_CLEAN'] ?>" id="contacts-phone-sale">
                                    ...
                                    <div class="contacts-contact-parameter-wrapper">
                                        ...
                                        <div class="contacts-contact-text-wrap">
                                            ...
                                            <div class="contacts-contact-text">
                                                ...
                                                <a class="contacts-contact-value" href="<?= 'tel:'.$arContact['SYSTEM_PROPERTIES']['PHONE_HELP']['VALUE_CLEAN'] ?>">
