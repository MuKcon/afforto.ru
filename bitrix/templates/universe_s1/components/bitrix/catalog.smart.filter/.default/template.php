            ...
            <div class="row">
                    ...
                    if(isset($arItem["PRICE"])):
                        ...
                        <div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
                            ...
                            <div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
                                <i data-role="prop_angle" class="fa-left-element-filter far fa-angle-<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>up<?else:?>down<?endif?>"></i>
                                        ...
                                        <div class="bx-filter-input-container">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-9"><input
                                                    ...
                                                    value="<?= $min_price_from_js ? ($min_price_from_js) : '' ?>"
                ...
                foreach($arResult["ITEMS"] as $key=>$arItem){
                    ...
                    <div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
                        <span class="bx-filter-container-modef"></span>
                        <div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
							<span class="bx-filter-parameters-box-hint"><i data-role="prop_angle" class="fa-left-element-filter far fa-angle-<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>up<?else:?>down<?endif?>"></i>
                                <?=$arItem["NAME"]?>
                            ...
                            <div class="bx-filter-popup-result right" id="modef" style="display: inline-block; display: none;">
                                <div class='selected-text'>
                                    ...
                                    <div class="popup-result-number">
                                        <?= GetMessage("CT_BCSF_FILTER_COUNT", [
                                            "#ELEMENT_COUNT#" => '<span id="modef_num">'.intval($arResult["ELEMENT_COUNT"]).'</span>']
                                        ) ?>
                                    </div>
                                    <a type="button" style="float: right" class="btn-bt-reset" href="<?= $arResult["FILTER_URL"]?>" target="">
