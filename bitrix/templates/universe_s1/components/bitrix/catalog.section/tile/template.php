...
$iLineCount = ArrayHelper::fromRange([2, 3, 4], $arParams['LINE_ELEMENT_COUNT']);
...
if (!empty($arResult['ITEMS'])) {?>
    <div class="intec-catalog-section intec-catalog-section-tile<?=$bUseDelimiter ?>" data-line-count="<?= $iLineCount ?>">
        <!-- items-container -->
        <div class="<?= Html::cssClassFromArray([
            'intec-catalog-section-wrapper',
            'intec-grid' => [
                '',
                'wrap',
                'a-h-start',
            ...
            foreach ($arResult['ITEMS'] as $cell => $arElement) {
                ...
                ?>
                <div id="<?= $this->GetEditAreaId($arElement['ID']) ?>" class="<?= Html::cssClassFromArray([
                    'catalog-section-element' => true,
                    'intec-grid-item' => [
                        '400-1' => $iLineCount < 4,
                        '650-2' => $iLineCount > 2,
                        '720-2' => $iLineCount == 2,
                        '720-3' => $iLineCount > 2,
                        '800-1' => !$bWide,
                        '950-2' => !$bWide && $iLineCount > 2,
                        '1200-3' => !$bWide && $iLineCount > 3,
                        $iLineCount => true
                    ]
                ], true) ?>" data-entity="items-row" data-product-id="<?=$arElement['ID']?>">
                    <div class="element-wrap">
                        <div class="element-img-wrap">
                            ...
                            <a href="<?= $sDetailPage ?>" class="element-img intec-image-effect">
