    ...
    <div class="intec-catalog-section intec-catalog-section-text" data-entity="<?= $containerName ?>">
        ...
        foreach ($arResult["ITEMS"] as $cell => $arElement) {
            ...
            if ($bCanBuy && !$bOffersExist) {
                ...
                $arBasketAdd = [
                    'class' => 'intec-button intec-button-w-icon intec-button-transparent intec-button-md intec-button-fs-16 intec-button-cl-common add',
                ...
                $arBasketAdded = [
                    'class' => 'intec-button intec-button-w-icon intec-button-md intec-button-fs-16 intec-button-cl-common added',
                    'href' => $sBasketUrl,
                ...
                <div class="element-catalog">
                    ...
                    <?php if ($arParams['USE_BASKET'] == 'Y') {?>
                        ...
                        <?php } else if ($bOffersExist && $bCanBuy) { ?>
                            <div class="buys">
                                <a href="<?= $sDetailPage ?>" class="intec-button intec-button-w-icon intec-button-transparent intec-button-md intec-button-fs-16 intec-button-cl-common">
                                    <span class="intec-button-icon intec-basket glyph-icon-cart"></span>
                                    <span class="intec-button-text intec-basket-text">
                                        <?= $sMoreInfo ?>
                                    </span>
