            ...
            <div class="intec-content-wrapper">
                <div class="intec-grid intec-grid-wrap">
                    <?php if ($arResult['MAP']['SHOW']) { ?>
                        <div class="intec-grid-item-2 catalog-store-detail-map">
                    ...
                    <?php } ?>
                    <div class="intec-grid-item catalog-store-detail-properties">
                        ...
                        <div class="catalog-store-detail-property intec-grid intec-grid-nowrap">
                            <?php if (!empty($arResult['DESCRIPTION'])) { ?>
                                <div class="intec-grid-item catalog-store-detail-description" itemprop="description">
                                    <?= $arResult['DESCRIPTION'] ?>
                                </div>
                            <?php } ?>
                        </div>
                        <?php if (!empty($arResult['LIST_URL'])) { ?>
