...
$bRegister = COption::GetOptionString('main', 'new_user_registration', 'N') === 'Y';
...
<div class="system-auth-authorize">
    <div class="row">
                        ...
                        <?php if ($arResult['STORE_PASSWORD'] == 'Y') { ?>
                            <div class="col-xs-6 rememberme">
                                <label class="USER_REMEMBER right intec-input intec-input-checkbox">
                                    ...
                                    <span class="intec-input-text"><?= GetMessage('AUTH_REMEMBER_ME') ?></span>
                                </label>
                            </div>
                        <?php } ?>
                    </div>
        ...
        <div class="col-xs-12 col-sm-5 reg_block">
            <?php if ($bRegister) { ?>
                <a rel="nofollow" href="<?= $arParams['AUTH_REGISTER_URL'] ? $arParams['AUTH_REGISTER_URL'] : $arResult['AUTH_REGISTER_URL'] ?>"
