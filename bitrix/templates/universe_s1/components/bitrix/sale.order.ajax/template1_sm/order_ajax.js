	...
	BX.Sale.OrderAjaxComponent = {
		...
		getBlockFooter: function(node)
		{
			...
			if (currentSection && currentSection.id.indexOf(firstSection.id) == '-1')
			{
				buttons.push(
					BX.create('A', {
						props: {
							href: '',
							className: 'intec-button-back-step pull-left intec-button intec-button-cl-default intec-button-transparent intec-button-md'
						},
						...
						children: [
							BX.create('span', {
								props: {className: 'intec-arrow-icon far fa-angle-left'}
							}),
							BX.create('span', {
								html: this.params.MESS_BACK
							})
			...
			if (!isLastNode)
			{
				buttons.push(
					BX.create('A', {
						props: {href: '', className: 'intec-button-next-step pull-right intec-button intec-button-cl-common intec-button-md'},
						...
						children: [
							...
							BX.create('span', {
								props: {className: 'intec-arrow-icon far fa-angle-right'}
							})
						]
					})
				);
			...
			button = BX.create('DIV', {
				...
				children: [
					...
					BX.create('INPUT', {
						props: {
							type: 'submit',
							className: 'intec-button intec-button-cl-common intec-button-lg',
		...
		editSocialContent: function(authContent)
		{
			...
			nodes.push(BX.create('DIV', {
				...
				children: [
					...
					BX.create('A', {
						props: {className: 'intec-button intec-button-cl-common intec-button-lg'},
		...
		editPaySystemInfo: function(paySystemNode)
		{
			...
			var paySystemInfoContainer = BX.create('DIV', {
					props: {
						className: (this.result.PAY_SYSTEM.length == 0 ? 'col-sm-12' : 'col-sm-12') + ' bx-soa-pp-desc-container'
					}
				}),
		...
		editDeliveryItems: function(deliveryNode)
		{
			...
			var deliveryItemsContainer = BX.create('DIV', {
					props: {
						className: 'col-sm-12 bx-soa-pp-item-container'
					}
				}),
				deliveryItemNode, k;
		...
		editDeliveryInfo: function(deliveryNode)
		{
			...
			var deliveryInfoContainer = BX.create('DIV', {
					props: {
						className: 'col-sm-12 bx-soa-pp-desc-container'
					}
				}),
		...
		activatePickUp: function(deliveryName)
		{
			...
			this.pickUpBlockNode.querySelector('h2.bx-soa-section-title').innerHTML =
				deliveryName + '<span class="bx-soa-section-title-count"></span>';
						...
						children: [
							BX.create('A', {
								props: {
									...
									className: 'btn-lg btn-order-save intec-button intec-button-cl-common intec-button-lg intec-button-block'
								},
