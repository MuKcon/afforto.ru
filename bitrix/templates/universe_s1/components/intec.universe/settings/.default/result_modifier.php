...
$arResult['MAIN_BLOCKS'] = array(
    ...
    'video' => array(
        'name' => GetMessage('UNIVERSE_SETTINGS_BLOCK_VIDEO'),
        'template' => 'template_video'
    ),
    'advantages' => array(
        'name' => GetMessage('UNIVERSE_SETTINGS_BLOCK_ADVANTAGES'),
        'template' => 'template_advantages'
    ),
    'staff' => array(
        'name' => GetMessage('UNIVERSE_SETTINGS_BLOCK_STAFF'),
        'template' => 'template_staff'
    ),
    'faq' => array(
        'name' => GetMessage('UNIVERSE_SETTINGS_BLOCK_FAQ'),
        'template' => 'template_faq'
    ),
    'stages' => array(
        'name' => GetMessage('UNIVERSE_SETTINGS_BLOCK_STAGES'),
        'template' => 'template_stages'
    ),
    'certificates' => array(
        'name' => GetMessage('UNIVERSE_SETTINGS_BLOCK_CERTIFICATES'),
        'template' => 'template_sertifikaty'
    ),
    'news' => array(
    ...
    'rates' => array(
        'name' => GetMessage('UNIVERSE_SETTINGS_BLOCK_RATES'),
        'template' => 'template_rates'
    ),
    'videos' => array(
        'name' => GetMessage('UNIVERSE_SETTINGS_BLOCK_VIDEOS'),
        'template' => 'template_videos'
    ),
    'contact' => array(
        'name' => GetMessage('UNIVERSE_SETTINGS_BLOCK_CONTACT'),
