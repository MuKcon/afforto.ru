...
$arResult['VISUAL'] = [
    ...
    'SLIDER' => [
        ...
        'AUTO' => [
            'USE' => ArrayHelper::getValue($arParams, 'SLIDER_AUTO') == 'Y',
            'TIME' => ArrayHelper::getValue($arParams, 'SLIDER_AUTO_TIME'),
            'SPEED' => ArrayHelper::getValue($arParams, 'SLIDER_AUTO_SPEED'),
            'PAUSE' => ArrayHelper::getValue($arParams, 'SLIDER_AUTO_PAUSE')
        ]
    ]
];
