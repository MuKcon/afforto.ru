                                    ...
                                    <div class="intec-grid-item-1 intec-grid-item-550-2 intec-grid-item-400-1">
                                        <div class="<?= Html::cssClassFromArray([
                                            ...
                                            <div class="widget-part-item-phone-wrapper">
												<a id="bottom_1" class="tel widget-part-item-text" href="tel:<?= $arResult['PHONE']['VALUE']['LINK'] ?>">
                                                    <span class="value"><?= $arResult['PHONE']['VALUE']['DISPLAY'] ?></span>
                                                </a>
                                                <?php if ($bSecondPhoneShow) { ?>
                                                    <a id="bottom_2" class="tel widget-part-item-text" href="tel:<?= $arResult['PHONE']['SECOND']['VALUE']['LINK'] ?>">
