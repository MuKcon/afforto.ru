...
<div class="intec-content intec-content-visible">
    <div class="intec-content-wrapper">
        <div class="widget-services-view widget-services-view-blocks-small clearfix">
                ...
                ?>
                    <div class="widget-services-element">
                        <div class="widget-services-element-wrapper" id="<?= $sAreaId ?>">
                            <a class="widget-services-element-image intec-image-effect" style="background-image: url('<?= $sImage ?>')" href="<?= $arItem['DETAIL_PAGE_URL'] ?>"></a>
                            <div class="widget-services-element-information">
                                <a class="widget-services-element-name intec-cl-text-hover" href="<?= $arItem['DETAIL_PAGE_URL'] ?>">
                                    <?= $arItem['NAME'] ?>
                                </a>
