 ...
 */
?>
<div class="widget-shares-view widget-shares-view-compact">
    <div class="widget-shares-view-wrapper">
        <?php foreach ($arResult['ITEMS'] as $arItem) { ?>
            ...
            ?>
            <div class="widget-shares-item">
                <div class="widget-shares-item-wrapper" id="<?= $sAreaId ?>">
                    <a href="<?= $arItem['DETAIL_PAGE_URL'] ?>" class="widget-shares-item-image intec-image-effect" style="background-image: url('<?= $sImage ?>')"></a>
