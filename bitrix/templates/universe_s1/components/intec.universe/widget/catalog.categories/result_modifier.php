        ...
        if (!empty($build)) {
            ...
            if ($propertiesUse) {
                ...
                switch ($views['desktop']) {
                    case 'default':
                        $arParams['VIEW_DESKTOP'] = 'default.desktop';
                        break;
                    case 'default.simple':
                        $arParams['VIEW_DESKTOP'] = 'default.desktop.simple';
                        break;
                }
...
$sView = ArrayHelper::fromRange(['default.desktop', 'default.desktop.simple'], $sView);
