...
if ($arCurrentValues['FOOTER_SHOW_SOCIAL'] == 'Y') {
    ...
    $arTemplateParameters['FOOTER_YOUTUBE'] = [
        'PARENT' => 'BASE',
        'TYPE' => 'STRING',
        'NAME' => 'Социальные сети. Youtube'
    ];
    $arTemplateParameters['FOOTER_TELEGA'] = [
        'PARENT' => 'BASE',
        'TYPE' => 'STRING',
        'NAME' => 'Социальные сети. Telegram'
    ];
    $arTemplateParameters['FOOTER_ZEN'] = [
        'PARENT' => 'BASE',
        'TYPE' => 'STRING',
        'NAME' => 'Социальные сети. Zen'
    ];
    $arTemplateParameters['FOOTER_ODNOKLASSNIKI'] = [
        'PARENT' => 'BASE',
        'TYPE' => 'STRING',
        'NAME' => 'Социальные сети. Odnoklassniki'
    ];
