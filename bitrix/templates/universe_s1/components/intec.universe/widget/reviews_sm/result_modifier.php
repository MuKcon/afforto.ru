            ...
            if ($propertiesUse) {
                ...
                switch ($views['desktop']) {
                    ...
                    case 'blocks_2':
                        ...
                        break;
                    case 'blocks_video':
                        $arParams['VIEW_DESKTOP'] = 'blocks.video';
                        break;
                }
                ...
                switch ($views['mobile']) {
                    ...
                    case 'blocks_2':
                        ...
                        break;
                    case 'blocks_video':
                        $arParams['VIEW_MOBILE'] = 'blocks.video';
                        break;
                }
            }
        }
...
$sView = ArrayHelper::fromRange(['default.all', 'slider.all', 'blocks.all', 'blocks.2.desktop', 'blocks.video'], $sView);
$arParams['VIEW_DESKTOP'] = $sView;

$sView = ArrayHelper::getValue($arParams, 'VIEW_MOBILE');
$sView = ArrayHelper::fromRange(['default.all', 'slider.all', 'blocks.all', 'blocks.2.mobile', 'blocks.video'], $sView);
