...
<div class="widget-block-item widget-block-item-phone">
                                    ...
                                    <?php foreach ($arResult['PHONE']['VALUES'] as $arPhone) { ?>
                                        <div class="widget-block-item-value">
                                            <a id="contact_tp" href="tel:+74957408093" class="intec-cl-text-hover" id="main-contact-form">
                                                +7 (495) 740 80 93
                                            </a>
                                        </div>
                                    <?php } ?>
	...
	<div class="widget-block-item widget-block-item-req">
	...
	"EDIT_TEMPLATE" => "",
	"PATH" => "/include/requisites.php"
	)
	);?>
	</div>
	<style>
	.widget-block-item-req .requisites{float:none;width:100%;}
	</style>
	<?endif;?>
