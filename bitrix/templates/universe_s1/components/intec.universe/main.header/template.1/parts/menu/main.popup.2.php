...
<?php $APPLICATION->IncludeComponent(
    ...
    ArrayHelper::merge([
        ...
        'CONTACTS_SHOW_ADDRESS' => $arParams['CONTACTS_SHOW_ADDRESS'],
        'CONTACTS_SHOW_SCHEDULE' => $arParams['CONTACTS_SHOW_SCHEDULE'],
        'CONTACTS_SHOW_EMAIL' => $arParams['CONTACTS_SHOW_EMAIL'],
