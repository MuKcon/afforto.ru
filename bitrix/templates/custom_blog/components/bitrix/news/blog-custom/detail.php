...
$bSubscribeShow = $arViewParams['LIST_SUBSCRIBE_SHOW_IN_DETAIL'] && $bSubscribe;
$bNewsTopShow = $arViewParams['LIST_NEWS_TOP_SHOW_IN_DETAIL'];

$sNofFullView = (!$bSubscribeShow && $arViewParams['LIST_SUBSCRIBE_SHOW']) ||
    (!$bNewsTopShow && $arViewParams['LIST_NEWS_TOP_SHOW']) ? ' not-full-view' : null;

?>
<div class="intec-content">
	<div class="intec-content-wrapper">
		<div class="ns-bitrix c-news c-news-blog<?= $arViewParams['DETAIL_TWO_COLUMNS'] ? ' two-columns' : null ?>">
			<div class="news-elements-content<?= $arViewParams['DETAIL_TWO_COLUMNS'] ? ' main-column' : null ?>">
