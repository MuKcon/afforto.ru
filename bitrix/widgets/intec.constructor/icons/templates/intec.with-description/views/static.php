            ...
            <?php foreach ($items as $item) { ?>
                <?= Html::beginTag($item['link'] !== null ? 'a' : 'div', [
                    ...
                    <div class="widget-icons-item-wrapper">
                        ...
                        <?= Html::beginTag('div', [
                            'class' => 'widget-icons-description',
                            'style' => [
                                'font-weight' => $description['style']['bold'] ? 'bold' : null,
                                'font-style' => $description['style']['italic'] ? 'italic' : null,
                                'text-decoration' => $description['style']['underline'] ? 'underline' : null,
                                'color' => $description['text']['color'],
                                'font-size' => $description['text']['size'],
                                'text-align' => $description['text']['align'],
