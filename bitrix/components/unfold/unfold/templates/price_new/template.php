...
<style>
	...
	.kol_tovar_plus_minus .input-group-btn .btn {
	...
	@media print {
		...
		.type_price,
		#show_price div[id$="noPrint"],
		#show_price tr[id$="noPrint"] {
			display: none !important;
		}
		...
		<div class="row">
			<div class="col-md-12">
				<div class="main">
					...
					<div class="row">
						<div id="catalog_uslug" class="col-md-9 col-sm-9">
						...
						<div id="itogo" class="col-md-3 col-sm-3 text-right">
								...
								<div class="total_price">
									...
									<? $APPLICATION->IncludeComponent(
										...
										array(
											...
											"ID" => "19",
											"LAZYLOAD_USE" => "Y",
											"NAME" => "Оставить заявку и получить КП",
											"SETTINGS_USE" => "N",
											"TEMPLATE" => ".default",
											"THEME" => "dark",
											"TITLE" => "Получить КП",
									...
									<div class="type_price ">
										<div class="checkbox">
											<label><input type="checkbox" onclick="onCheckBox(this)" checked="">Только заполненные</label>
										</div>
									</div>
								</div>
							</div>
