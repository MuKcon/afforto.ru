...
$APPLICATION->SetPageProperty("description", "Здесь Вы можете найти список клиентов и заказчиков компании Afforto, а также посмотреть их основной вид деятельности и перейти на сайты наших клиентов.");
$APPLICATION->SetPageProperty("keywords", "клиенты, заказчики, сотрудничество");
$APPLICATION->SetPageProperty("title", "Список клиентов и заказчиков компании Afforto");
