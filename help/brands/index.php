...
$APPLICATION->SetPageProperty("title", "Бренды – информация компании Afforto");
$APPLICATION->SetPageProperty("description", "Бренды. Самые последняя и актуальна информация компании Afforto. Еще больше полезной информации вы сможете найти на страницах нашего сайта.");
